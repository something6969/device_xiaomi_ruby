...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/misound_res_ruby_spk.bin:$(TARGET_COPY_OUT_VENDOR)/etc/misound_res_ruby_spk.bin \
    $(LOCAL_PATH)/configs/audio/misound_res_rubypro_spk.bin:$(TARGET_COPY_OUT_VENDOR)/etc/misound_res_rubypro_spk.bin \
